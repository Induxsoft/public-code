function main()
{
	...
	// *********************************
	MainForm.AddUserCommand("1", "Captura de productos a granel", "Despliega la ventana de captura de productos a granel", "pos_usercmds.tomate",false,0xC000);
    MainForm.AddUserCommand("2", "Captura de productos a granel", "Despliega la ventana de captura de productos a granel", "pos_usercmds.manzanaroja",false,0xC000);
}
...
function tomate()
{
 ...
 function manzanaroja()
{
	pos_usercmds.granel("123");
}
